...
class Experiment():
    def __init__(self, canvas, design, day, participantid):
        ...
        self.instructions = Instructions(self.responsekeys, self.todays_multi, self.todays_single)
    ...
    def block_leadup(self, btype):
        block_instructions, recmem_instructions1,recmem_instructions2, response_instructions = self.instructions.block_instructions(btype)
